...
description: >
  Published assumptions and "not modelled" disclaimer printed at the bottom
  of every chart page. Engine values flow in via {token} substitution at
  render time; the prose lives here so authors can edit without touching code.

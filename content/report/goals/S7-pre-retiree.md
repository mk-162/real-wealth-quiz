...
rationale: "Fully supported. The work now is sequencing and tax efficiency — not building the pot further."
...
rationale: "Achievable. The drawdown sequencing conversation is the natural next step — the right order saves a meaningful amount in tax over 10 years."
...
rationale: "This goal costs the estate more in inheritance tax for every year the gifting clock is not running. Starting early is the entire planning insight here."
...
rationale: "Well-supported. A brief care-funding awareness conversation — what the thresholds are, what the options look like — is the only thing missing from the picture."
